...
<div class="page-wrapper">
    ...
    <div class="banner-section">
		<div class="main-slider-carousel owl-carousel owl-theme">
			...
			<div class="slide" data-bg-image="/resources/images/main-slider/intro-1.jpg">
	...
	<!-- CTA Section Start -->
	<div class="cta-section" data-bg-image="/resources/images/background/cta-bg.jpg">
		<div class="auto-container">
					...
					<div class="image-column col-lg-6">
						<div class="about-image">
							<div class="about-inner-image">
								<img src="resources\images\about\home-about.png" alt="about">
							</div>
						</div>
					</div>
			...
			<div class="row clearfix">
				...
				<div class="team-block col-lg-4 col-md-6 col-sm-6 col-12">
					<div class="inner-box wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
						<div class="image">
							<a href="#"><img src="/resources/images/resource/team-1.jpg" alt="" /></a>
							<!-- Social Box -->
							<ul class="social-box">
								<li><a href="https://twitter.com/" class="icofont-twitter"></a></li>
								<li><a href="http://facebook.com/" class="icofont-facebook"></a></li>
				...
				<div class="team-block col-lg-4 col-md-6 col-sm-6 col-12">
					<div class="inner-box wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
						<div class="image">
							<a href="#"><img src="/resources/images/resource/team-2.jpg" alt="" /></a>
							<!-- Social Box -->
							<ul class="social-box">
								<li><a href="https://twitter.com/" class="icofont-twitter"></a></li>
								<li><a href="http://facebook.com/" class="icofont-facebook"></a></li>
				...
				<div class="team-block col-lg-4 col-md-6 col-sm-6 col-12">
					<div class="inner-box wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1500ms">
						<div class="image">
							<a href="#"><img src="/resources/images/resource/team-3.jpg" alt="" /></a>
							<!-- Social Box -->
							<ul class="social-box">
								<li><a href="https://twitter.com/" class="icofont-twitter"></a></li>
								<li><a href="http://facebook.com/" class="icofont-facebook"></a></li>
				...
				<div class="clearfix row g-0">
							...
							<div class="inner-box">
								<div class="clearfix">
									...
									<div class="image-column col-lg-6 col-md-6 col-sm-12">
										<div class="inner-column">
											<div class="image">
												<a href="blog-detail.html"><img src="/resources/images/resource/news-1.jpg" alt="" /></a>
											</div>
										</div>
									</div>
									<!-- Content Column -->
							...
							<div class="inner-box">
								<div class="clearfix row g-0">
									...
									<div class="image-column col-lg-6 col-md-6 col-sm-12 order-lg-2 order-1">
										<div class="inner-column">
											<div class="image">
												<a href="blog-detail.html"><img src="/resources/images/resource/news-2.jpg" alt="" /></a>
											</div>
										</div>
									</div>
								</div>
					...
					<div class="column col-lg-4 col-md-12 col-sm-12">
						...
						<div class="news-block-two">
							<div class="inner-box">
								<div class="image">
									<a href="blog-detail.html"><img src="/resources/images/resource/news-3.jpg" alt="" /></a>
									<div class="arrow"></div>
								</div>
