			...
			<div class="row">
				<div class="col-lg-12">
					<div class="custom-column-thumbnail mt-lg-70">
						<img class="w-100" src="/resources/images/project/project-1.jpg" alt="finance">
					</div>
				</div>
			</div>
			...
			<div class="custom-layout-gallery mt-lg-100">
				<div class="row mb-n30">
					<div class="col-lg-6 col-md-6 col-12">
						<div class="thumbnail">
							<img class="w-100" src="/resources/images/project/project-3.jpg" alt="finance">
						</div>
					</div>
					<div class="col-lg-6 col-md-6 col-12 mt-50">
						<div class="thumbnail">
							<img class="w-100" src="/resources/images/project/project-4.jpg" alt="finance">
						</div>
					</div>

					<div class="col-lg-12 mtb-30">
						<div class="thumbnail">
							<img class="w-100" src="/resources/images/project/project-2.jpg" alt="finance">
						</div>
					</div>
				</div>
			</div>
